...
function findWasmBinary() {
    var f = 'angle_shader_translator_standalone.wasm';
    if (!isDataURI(f)) {
      return locateFile(f);
    }
    return f;
...
var _invoke = Module['_invoke'] = createExportWrapper('invoke', 1);
var _initialize = Module['_initialize'] = createExportWrapper('initialize', 0);
var _finalize = Module['_finalize'] = createExportWrapper('finalize', 0);
